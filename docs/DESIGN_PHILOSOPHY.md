...
The old repository is reference material, not the architectural template.
...
- Level 0: Pure portable JAX implementation.
- Level 1: JIT compilation.
- Level 2: Device-aware sharding and runtime policies.
- Level 3: Optional accelerator kernels (Pallas or equivalent).
- Level 4: Architecture-specific fused implementations.
